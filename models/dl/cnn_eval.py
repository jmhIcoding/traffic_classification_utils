...
from data_utils import LoadDataNoDefCW100,LoadDataNoDefCW,LoadDataWalkieTalkieCW,LoadDataApp,LoadDataApp,LoadDataApp_crossversion
...
def test_cnn(X_train,y_train,X_valid,y_valid,X_test,y_test):
    ...
    print('simple CNN  Test on test dataset accuracy :{0}'.format(score))
...
if __name__ == '__main__':
    X_train, y_train, X_valid, y_valid, X_test, y_test =  LoadDataApp_crossversion()
